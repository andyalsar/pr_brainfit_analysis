...
def clean_biometric_data(biometric_df, user_df):
    ...
    working_start = time.fromisoformat(WORKING_HOURS['start'])
    working_end = time.fromisoformat(WORKING_HOURS['end'])
    ...
    def calculate_stress_score(row):
        ...
        # Calculate what percentage of their max HR they're using
